...
export const mockEntries: Entry[] = [
  {
    ...
    feature_status: null,
    is_non_coding: false,
    git_validation_result: 'pending',
    git_score_adjustment: 0,
    git_evidence: null,
...
export const mockTrainingPlans: TrainingPlan[] = [
  {
    ...
    is_archived: false,
    plan_topics: [
      { id: 1, plan_id: 1, topic_id: 6, sequence_order: 1, expected_hours: 10, node_type: 'topic' },
      { id: 2, plan_id: 1, topic_id: 5, sequence_order: 2, expected_hours: 15, node_type: 'topic' },
      { id: 3, plan_id: 1, topic_id: 7, sequence_order: 3, expected_hours: 8, node_type: 'topic' },
      { id: 4, plan_id: 1, topic_id: 8, sequence_order: 4, expected_hours: 10, node_type: 'topic' },
      { id: 5, plan_id: 1, topic_id: 9, sequence_order: 5, expected_hours: 5, node_type: 'topic' },
    ],
    assignments: [
  ...
  },
  {
    ...
    is_archived: false,
    plan_topics: [
      { id: 6, plan_id: 2, topic_id: 10, sequence_order: 1, expected_hours: 25, node_type: 'topic' },
      { id: 7, plan_id: 2, topic_id: 11, sequence_order: 2, expected_hours: 20, node_type: 'topic' },
      { id: 8, plan_id: 2, topic_id: 12, sequence_order: 3, expected_hours: 15, node_type: 'topic' },
    ],
    assignments: [
